...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            background: url('https://media.tenor.com/XA6_dE7q6BUAAAAM/kaoruko-waguri-waguri-kaoruko.gif') no-repeat center center fixed;
        ...
        .login-image {
            ...
            border-radius: 50%;
            overflow: hidden;
            background: url('https://64.media.tumblr.com/ec35c729bb89716df6e979fe14dc3b37/6e74b057f159474a-e8/s540x810/b9043b7771d34d62419b4f8e2e632ea953ef51a0.gif') no-repeat center center;
            background-size: cover;
            margin: 50px auto;
        }
